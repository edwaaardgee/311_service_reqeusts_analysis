...
Source Code:
GitHub repository: https://github.com/edwaaardgee/311-service-request-hadoop-analysis
...
You should see /user/<your_username>/tmp/311_service_requests
...
You should see 311_Service_Requests_from_2020_to_Present.csv
...
You should see Found 1 items /user/<your_username>/tmp/311_service_requests/311_Service_Requests_from_2020_to_Present.csv
...
Open a new local Git Bash window on your computer. Do not run this command inside the SSH terminal.
...
Hive external table created from HDFS data
HiveQL query results showing top service request categories
Cleaned 10,000-record subset
Top 5 map subset for readability
Excel 3D Map using latitude, longitude, problem type, and created_date
Slides, paper, tutorial, and source code in GitHub
